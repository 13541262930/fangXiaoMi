...
/***/ 17:
/*!*************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/store/index.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _cart = _interopRequireDefault(__webpack_require__(/*! ./modules/cart.js */ 19));
var _path = _interopRequireDefault(__webpack_require__(/*! ./modules/path.js */ 21));
var _user = _interopRequireDefault(__webpack_require__(/*! ./modules/user.js */ 22));
var _order = _interopRequireDefault(__webpack_require__(/*! ./modules/order.js */ 23));
var _member = _interopRequireDefault(__webpack_require__(/*! ./modules/member.js */ 24));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}_vue.default.use(_vuex.default);var _default =
new _vuex.default.Store({
  modules: {
    cart: _cart.default, path: _path.default, user: _user.default, order: _order.default, member: _member.default } });exports.default = _default;
...
/***/ 19:
/*!********************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/store/modules/cart.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/common/lib/request.js */ 20));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  state: {
    data: {
      list: [
  ...
  getters: {
    ...
    getGoods: function getGoods(state) {
      var num = 0;
      state.data.list.map(function (v) {
        num += v.num;
      });
      return num;
    },
    // 获取购物车选中商品
    getCartds: function getCartds(state) {
      var cartList = [];
      var selecteds = state.data.selectedList;
      state.data.list.map(function (v) {
    ...
    // 计算总件数
    getSumNumner: function getSumNumner(state) {
      var number = 0;
      var selecteds = state.data.selectedList;
      state.data.list.forEach(function (v) {
        if (selecteds.indexOf(v.selected) > -1) {
          number += v.num;
        }
      });
  ...
  mutations: {
    ...
    selectItem: function selectItem(state, index) {
      var id = state.data.list[index].selected;
      console.log(id, "--------");
      var i = state.data.selectedList.indexOf(id);
    ...
    selectALL: function selectALL(state) {
      state.data.selectedList = state.data.list.map(function (v) {
        // 设置选中状态
        v.checked = true;
        return v.selected;
      });
    ...
    // 长按删除
    longDel: function longDel(state, item) {
      _request.default.delete('/orders/shopcarts/' + item.selected + "/").then(function (res) {
        state.data.list = state.data.list.filter(function (v) {
    ...
    delGoods: function delGoods(state) {
      if (state.data.selectedList.length == 1) {
        _request.default.delete('/orders/shopcarts/' + state.data.selectedList[0] + "/").then(function (res) {
          console.log(res);

          state.data.list = state.data.list.filter(function (v) {
            var index = state.data.selectedList.indexOf(v.selected);
            if (index === -1) {
              return true;
            } else {
        ...
        _request.default.delete('/orders/shopcarts/multiple_delete/?delete_id=' + state.data.selectedList.join(",")).then(function (res) {
          console.log(res);
          state.data.list = state.data.list.filter(function (v) {
            var index = state.data.selectedList.indexOf(v.selected);
            if (index === -1) {
    ...
    // 修改商品数量
    changeNum: function changeNum(state, _ref) {var num = _ref.num,item = _ref.item;
      for (var i = 0; i < state.data.list.length; i++) {
        var it = state.data.list[i];
        console.log(it);
        if (it === item) {
          it.num = num;
          _request.default.put('/orders/shopcarts/' + it.selected + "/", {
            goods: it.id,
            nums: num,
    ...
    addGoodsToCart: function addGoodsToCart(state, goods) {
      // 往后台发送添加商品请求
      console.log(goods);
      _request.default.post('/orders/shopcarts/', {
        goods: goods.id,
        nums: goods.num,
      ...
      then(function (res) {
        console.log(res);
        var goodId = 0;
        var ids = state.data.list.map(function (v, i) {
      ...
      _request.default.get("/orders/shopcarts/").then(function (res) {
        if (res.length > 0) {
          ...
          s) {
            ...
            labels = [];
            var list_list = [];
            item.goods.goods_sku.map(function (v, vi) {
            ...
            var skuItem = item.goods.goods_sku;
            skuItem.map(function (v) {
            ...
            });};for (var s = 0; s < res.length; s++) {var labels;_loop(s);
          }
        } else {
          state.data.list = [];
        }
  ...
  actions: {
    ...
    // 清理购物车
    // 支付清楚购物车商品
    changeData: function changeData(_ref2) {var state = _ref2.state,commit = _ref2.commit;
      var item = state.data.list;
      var list = state.data.selectedList;
    ...
    doSelectedAll: function doSelectedAll(_ref3) {var commit = _ref3.commit,getters = _ref3.getters;
    ...
    // 显示隐藏
    doShowPopup: function doShowPopup(_ref5, index) {var state = _ref5.state,commit = _ref5.commit;
      commit('initPopupIndex', index);
      state.data.popupShow = "show";
    },
    // 隐藏popup
    doHidePopup: function doHidePopup(_ref6) {var state = _ref6.state;
...
/***/ 20:
/*!********************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/common/lib/request.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _index = _interopRequireDefault(__webpack_require__(/*! @/store/index.js */ 17));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default =
{
  ...
  request: function request() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    ...
    if (_index.default.state.user.token) {
      this.common.header["Authorization"] = "JWT" + " " + _index.default.state.user.token;
  ...
  // get请求
  get: function get(url) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var isurl = arguments.length > 2 ? arguments[2] : undefined;var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    options.isurl = isurl;
    options.url = url;
    options.data = data;
    options.method = "GET";
  ...
  // post请求
  post: function post(url) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var isurl = arguments.length > 2 ? arguments[2] : undefined;var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
    options.isurl = isurl;
    options.url = url;
    options.data = data;
    options.method = "POST";
...
/***/ 21:
/*!********************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/store/modules/path.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/common/lib/request.js */ 20));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  ...
  mutations: {
    ...
    createPath: function createPath(state, item) {
      ...
      // }
      _request.default.post('/goods/address/', item).then(function (res) {
        state.list.unshift(res);
      });
    },
    //删除收货地址
    delPath: function delPath(state, index) {
      _request.default.delete('/goods/address/' + state.list[index].id + "/").then(function (res) {
        console.log(res);
        uni.showToast({
          title: "删除成功 " });
    ...
    // 修改收货地址
    updatePath: function updatePath(state, _ref) {var index = _ref.index,item = _ref.item,callback = _ref.callback;
      console.log(JSON.stringify(item));
      _request.default.put('/goods/address/' + state.list[index].id + "/", item).then(function (res) {
        for (var key in res) {
    ...
    // 全部取消默认收货地址
    removueDefault: function removueDefault(state) {
      // 取消本地默认收货地址
    ...
    changeDefault: function changeDefault(state, index) {
    ...
    getList: function getList(state) {
      // 从服务器获取收货地址
      _request.default.get("/goods/address/").then(function (res) {
  ...
  actions: {
    ...
    setDefault: function setDefault(_ref4, index) {var commit = _ref4.commit;
      commit('removueDefault');
...
/***/ 22:
/*!********************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/store/modules/user.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _index = _interopRequireDefault(__webpack_require__(/*! @/store/index.js */ 17));
var _request = _interopRequireDefault(__webpack_require__(/*! @/common/lib/request.js */ 20));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  state: {
    // 判断是否显示动画
    beforeReady: true,
  ...
  mutations: {
    // 修改昵称
    change_nickname: function change_nickname(state, nickname) {
      state.userInfo.nickname = nickname;
      // 给后台发送修改昵称请求
    },
    // 初始化登录状态
    inituser: function inituser(commit) {var _this = this;
      var res = JSON.parse(uni.getStorageSync('userInfo'));
      if (res) {
        _request.default.post('/users/api-token-verify/', {
          token: res.token }).
        then(function (re) {
          console.log(re);
          if (re.token) {
            _this.commit('login', res);
          }
        });
      }
    },
    // 登录
    login: function login(state, item) {
      if (item.token) {
        // 刷新token加长时间
        _request.default.post('/users/refresh_jwt_token/', { token: item.token }).then(function (res) {
          item['token'] = res.token;
          state.userInfo = item;
          state.token = res.token;
          state.beforeReady = false; //消除购物车动画
          state.loginStatus = true; //改变登录状态
          _index.default.commit('getList');
          console.log(state.loginStatus);
          // 异步请求购物车数据
          _index.default.commit('cart_init');
        });
        // 持久化储存
    ...
    // 改变动画
    changeBeforeReady: function changeBeforeReady(state) {
...
/***/ 23:
/*!*********************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/store/modules/order.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/common/lib/request.js */ 20));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  state: {
    payUrl: {
      zhiFuBao: "",
  ...
  // 同步方法
  mutations: {
    changePayUrl: function changePayUrl(state, payUrl) {
      console.log(payUrl);
      state.payUrl = payUrl;
    } },
...
/***/ 24:
/*!**********************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/store/modules/member.js ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/common/lib/request.js */ 20));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  ...
  getters: {
    getIntegral: function getIntegral(state) {
      return state.integral;
    } },

  // 同步方法
  mutations: {
    changeIntegral: function changeIntegral(state, item) {
      state.integral = item;
    } },
...
/***/ 39:
/*!**********************************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/components/common/minxin/loading.js ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 4:
/*!*********************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/pages.json ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 46:
/*!***************************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/pages/class/classify.data.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 469:
/*!*********************************************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/components/uni-ui/uParse/src/libs/html2json.js ***!
  \*********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _wxDiscode = _interopRequireDefault(__webpack_require__(/*! ./wxDiscode */ 470));
var _htmlparser = _interopRequireDefault(__webpack_require__(/*! ./htmlparser */ 471));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
...
/***/ 470:
/*!*********************************************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/components/uni-ui/uParse/src/libs/wxDiscode.js ***!
  \*********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 471:
/*!**********************************************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/components/uni-ui/uParse/src/libs/htmlparser.js ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 484:
/*!********************************************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/components/uni-ui/uni-swipe-action/mpother.js ***!
  \********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 485:
/*!***************************************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/components/uni-ui/uni-swipe-action/mp.js ***!
  \***************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 495:
/*!*******************************************************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/components/uni-ui/mpvue-citypicker/city-data/province.js ***!
  \*******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 496:
/*!***************************************************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/components/uni-ui/mpvue-citypicker/city-data/city.js ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 497:
/*!***************************************************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/components/uni-ui/mpvue-citypicker/city-data/area.js ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 7:
/*!**************************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/pages.json?{"type":"style"} ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationBarTitleText": "小米商城" }, "pages/my/my": {}, "pages/class/class": { "navigationBarTitleText": "小米商城" }, "pages/cart/cart": {}, "pages/search/search": { "navigationBarTitleText": "小米商城" }, "pages/search-list/search-list": { "navigationBarTitleText": "小米商城", "enablePullDownRefresh": true }, "pages/detail/detail": {}, "pages/detail-common/detail-common": { "navigationBarTitleText": "商品评价", "enablePullDownRefresh": true }, "pages/user-seet/user-seet": {}, "pages/user-userinfo/user-userinfo": { "navigationBarTitleText": "修改资料" }, "pages/user-path-list/user-path-list": { "navigationBarTitleText": "收货地址" }, "pages/user-path-edit/user-path-edit": { "navigationBarTitleText": "增加收货地址" }, "pages/order/order": { "navigationBarTitleText": "我的订单", "enablePullDownRefresh": true }, "pages/order-confirm/order-confirm": { "navigationBarTitleText": "订单配送至", "navigationBarBackgroundColor": "#FD6801", "navigationBarTextStyle": "white" }, "pages/order-invoice/order-invoice": { "style": { "navigationBarTitleText": "发票", "navigationBarBackgroundColor": "#FD6801", "navigationBarTextStyle": "white", "app-plus": { "bounce": "none" } } }, "pages/login/login": {}, "pages/msg-list/msg-list": { "navigationBarTitleText": "消息列表" }, "pages/msg-detail/msg-detail": {}, "pages/pay-methods/pay-methods": { "navigationBarTitleText": "选择支付方式" }, "pages/pay-result/pay-result": { "navigationBarTitleText": "支付成功" }, "pages/order-coupon/order-coupon": { "navigationBarTitleText": "优惠卷" }, "pages/order-detail/order-detail": {}, "pages/logistics-deatil/logistics-deatil": { "navigationBarTitleText": "物流信息" }, "pages/after-sale/after-sale": { "navigationBarTitleText": "申请售后" }, "pages/about/about": { "navigationBarTitleText": "商城" }, "pages/personal/personal": {}, "pages/change-nickname/change-nickname": { "navigationBarTitleText": "修改昵称" }, "pages/change-gender/change-gender": { "navigationBarTitleText": "修改性别" }, "pages/like-goods/like-goods": { "navigationBarTitleText": "收藏的商品" }, "pages/phone/phone": {}, "pages/commodity-page/commodity-page": {}, "pages/members-center/members-center": { "navigationBarTitleText": "会员中心" }, "pages/page-rules/page-rules": {}, "pages/achievement-wall/achievement-wall": {}, "pages/integral-mall/integral-mall": { "navigationBarTitleText": " " }, "pages/integral-subsidiary/integral-subsidiary": {}, "pages/member-code/member-code": {}, "pages/indiana-activities/indiana-activities": { "navigationBarTitleText": " " }, "pages/sign-in/sign-in": {}, "pages/indiana-detail/indiana-detail": {}, "pages/integral-exchange/integral-exchange": { "navigationBarTitleText": " " }, "pages/integral-earn/integral-earn": {}, "pages/exchange-record/exchange-record": {}, "pages/receive-coupons/receive-coupons": { "navigationBarTitleText": "领取优惠券" }, "pages/signInRules/signInRules": {}, "pages/smallPlaneMember/smallPlaneMember": {}, "pages/permissions-Earnings/permissions-Earnings": {} }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "小米商城", "navigationBarBackgroundColor": "#FFFFFF", "backgroundColor": "#FFFFFF" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!*************************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/pages.json?{"type":"stat"} ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__6A031B6" };exports.default = _default;

/***/ }),

/***/ 83:
/*!*****************************************************************************!*\
  !*** /Users/longting/Desktop/个人开发项目/xiaoMiShangCheng/代码/common/lib/time.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
