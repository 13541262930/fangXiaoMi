...
Z([3,'__e'])
Z([3,'swiper-item'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[[5],[1,'openDetail']],[[4],[[5],[1,'$0']]]],[[4],[[5],[[4],[[5],[[4],[[5],[[5],[[5],[[5],[1,'resdata']],[1,'']],[[7],[3,'index']]],[1,'id']]]]]]]]]]]]]]])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'d-flex w-100 a-center'])
Z([3,'height:190rpx;background:rgb(215, 215, 215);position:relative;'])
Z([3,'widthFix'])
Z([3,'../../static/images/demo/demo6.jpg'])
Z([3,'width:120rpx;height:120rpx;border-radius:100%;margin-left:20rpx;'])
Z([3,'margin-left:20rpx;font-size:32px;'])
Z([3,'你好'])
Z([3,'iconfont icon-shezhi'])
Z([3,'font-size:24px;position:absolute;top:0;right:20rpx;width:46rpx;height:68rpx;'])
Z([3,'margin-left:20rpx;margin-right:20rpx;height:100%;background-color:rgb(250, 250, 250);'])
Z([3,'d-flex flex-nowrap w-100 j-sb '])
Z([3,'font-weight:800;color:red;font-size:24rpx;margin-top:36rpx;height:120rpx;border-radius:14rpx;background-color:rgb(255, 255, 255);border:#000000 solid .3px;'])
...
Z([3,'服务商'])
Z(z[12])
Z([3,'margin-right:36rpx;color:rgb(51, 51, 51);'])
Z(z[14])
Z([3,'服务'])
Z([3,'d-flex a-center j-sb'])
Z([3,'margin-top:40rpx;color:#FFFFFF;font-weight:800;'])
Z([3,'d-flex a-center j-center'])
Z([3,'background-color:rgb(233, 66, 78);width:228rpx;height:87rpx;border-radius:20rpx;'])
Z([3,'保单'])
Z(z[31])
Z(z[32])
Z([3,'服务单'])
...
var z=gz$gwx_1()
var oB=_n('view')
var xC=_mz(z,'swiper',['autoplay',-1,'circular',-1,'indicatorDots',-1,'duration',0,'indicatorActiveColor',1,'indicatorColor',1,'interval',2,'style',3],[],e,s,gg)
var oD=_v()
_(xC,oD)
var fE=function(hG,cF,oH,gg){
var oJ=_n('swiper-item')
var lK=_mz(z,'view',['bindtap',9,'class',1,'data-event-opts',2],[],hG,cF,gg)
var aL=_mz(z,'image',['lazyLoad',-1,'src',12,'style',1],[],hG,cF,gg)
_(lK,aL)
_(oJ,lK)
_(oH,oJ)
return oH
...
var o4=_mz(z,'uni-icon',['bind:__l',12,'class',1,'color',2,'size',3,'type',4,'vueId',5],[],e,s,gg)
_(e2,o4)
}
var b3=_v()
_(t1,b3)
...
var lCB=_mz(z,'view',['class',28,'style',1],[],e,s,gg)
var tEB=_n('slot')
_rz(z,tEB,'name',30,e,s,gg)
_(lCB,tEB)
var aDB=_v()
_(lCB,aDB)
if(_oz(z,31,e,s,gg)){aDB.wxVkey=1
var eFB=_n('slot')
_rz(z,eFB,'name',32,e,s,gg)
_(aDB,eFB)
}
else{aDB.wxVkey=2
var bGB=_v()
...
var oJB=_mz(z,'uni-badge',['bind:__l',34,'text',1,'type',2,'vueId',3],[],e,s,gg)
_(bGB,oJB)
}
var oHB=_v()
_(aDB,oHB)
if(_oz(z,38,e,s,gg)){oHB.wxVkey=1
var fKB=_mz(z,'switch',['bindchange',39,'checked',1,'data-event-opts',2,'disabled',3],[],e,s,gg)
_(oHB,fKB)
}
var xIB=_v()
_(aDB,xIB)
if(_oz(z,43,e,s,gg)){xIB.wxVkey=1
var cLB=_mz(z,'uni-icon',['bind:__l',44,'class',1,'color',2,'size',3,'type',4,'vueId',5],[],e,s,gg)
_(xIB,cLB)
}
bGB.wxXCkey=1
bGB.wxXCkey=3
...
var eZC=_mz(z,'image',['mode',2,'src',1,'style',2],[],e,s,gg)
_(tYC,eZC)
var b1C=_n('view')
_rz(z,b1C,'style',5,e,s,gg)
var o2C=_oz(z,6,e,s,gg)
_(b1C,o2C)
_(tYC,b1C)
var x3C=_mz(z,'view',['class',7,'style',1],[],e,s,gg)
_(tYC,x3C)
_(aXC,tYC)
var o4C=_n('view')
_rz(z,o4C,'style',9,e,s,gg)
var f5C=_mz(z,'view',['class',10,'style',1],[],e,s,gg)
...
_(hKD,oND)
_(f5C,hKD)
var aPD=_mz(z,'view',['class',25,'style',1],[],e,s,gg)
var tQD=_n('text')
...
var oVD=_mz(z,'view',['class',31,'style',1],[],e,s,gg)
var fWD=_oz(z,33,e,s,gg)
_(oVD,fWD)
_(xUD,oVD)
var cXD=_mz(z,'view',['class',34,'style',1],[],e,s,gg)
...
var l3D=_mz(z,'un-list-item',['bind:__l',41,'bind:click',1,'data-event-opts',2,'leftIcon',3,'leftIconStyle',4,'rightContent',5,'showExtraIcon',6,'vueId',7,'vueSlots',8],[],e,s,gg)
var a4D=_n('view')
var t5D=_oz(z,50,e,s,gg)
_(a4D,t5D)
_(l3D,a4D)
var e6D=_n('view')
_rz(z,e6D,'slot',51,e,s,gg)
var b7D=_oz(z,52,e,s,gg)
_(e6D,b7D)
_(l3D,e6D)
_(o2D,l3D)
var o8D=_mz(z,'un-list-item',['bind:__l',53,'bind:click',1,'data-event-opts',2,'leftIcon',3,'leftIconStyle',4,'rightContent',5,'showExtraIcon',6,'vueId',7,'vueSlots',8],[],e,s,gg)
var x9D=_oz(z,62,e,s,gg)
_(o8D,x9D)
_(o2D,o8D)
var o0D=_mz(z,'un-list-item',['bind:__l',63,'bind:click',1,'data-event-opts',2,'leftIcon',3,'leftIconStyle',4,'rightContent',5,'showExtraIcon',6,'vueId',7,'vueSlots',8],[],e,s,gg)
var fAE=_oz(z,72,e,s,gg)
_(o0D,fAE)
_(o2D,o0D)
var cBE=_mz(z,'un-list-item',['bind:__l',73,'bind:click',1,'data-event-opts',2,'leftIcon',3,'leftIconStyle',4,'rightContent',5,'showExtraIcon',6,'vueId',7,'vueSlots',8],[],e,s,gg)
var hCE=_oz(z,82,e,s,gg)
_(cBE,hCE)
_(o2D,cBE)
var oDE=_mz(z,'un-list-item',['bind:__l',83,'bind:click',1,'data-event-opts',2,'leftIcon',3,'leftIconStyle',4,'rightContent',5,'showExtraIcon',6,'vueId',7,'vueSlots',8],[],e,s,gg)
var cEE=_oz(z,92,e,s,gg)
_(oDE,cEE)
_(o2D,oDE)
_(o4C,o2D)
_(aXC,o4C)
...
setCssToHead([])();setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:162:1)",{path:"./app.wxss"})();

__wxAppCode__['app.wxss']=setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:162:1)",{path:"./app.wxss"});    
...
__wxAppCode__['pages/insurance/insurance.wxss']=undefined;    
