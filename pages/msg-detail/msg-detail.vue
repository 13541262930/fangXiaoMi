<template>
	<view class="p-2">
		<!-- 标题 -->
		<view class="font-lg text-dark mb-2">
			{{detail.title}}
		</view>
		<!-- 内容 -->
		<view class="p-2">
			<wx-pare :content="context" @preview="preview" @navigate="navigate"></wx-pare>
		</view>
	</view>
</template>
...
<script>
	...
	<pre><code class="language-javascript">    var a = document; //代码</code></pre>
	    `
	import wxPare from "@/components/uni-ui/uParse/src/wxParse.vue"
	export default {
		components:{
			wxPare
		},
